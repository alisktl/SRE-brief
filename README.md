...
Инцидент - это событие, привлекшее к снижению **бюджета ошибок**.

Выявление и устранение инцидентов важный пункт SRE.
